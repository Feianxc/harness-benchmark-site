import type { ArtifactRole, AutonomyMode, ComparisonMode, CompletenessVerdict, DigestString, EvidenceChannelMode, MemoryScope, ObjectType, PublicationState, RegistrationMode, ReleasePolicy, RepeatabilityClass, Split, SubmissionProfile, TaskResultStatus, TierEligibilityEffect, TraceHashChainMode, TrustTier, VisibilityClass, ZeroInputDigest } from "./enums.js";
