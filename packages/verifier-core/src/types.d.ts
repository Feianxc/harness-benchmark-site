import type { AutonomyMode, BoardDisposition as SharedBoardDisposition, BoardAdmissionDecision as SharedBoardAdmissionDecision, ComparisonMode, CompletenessProof as SharedCompletenessProof, DigestString, EvidenceChannelMode, InteractionSummary as SharedInteractionSummary, PublicationStateEvent as SharedPublicationStateEvent, PublicationState, ReleasePolicy, RepeatabilityClass, SubmissionProfile, TrustTier, VerificationRecord as SharedVerificationRecord, VisibilityClass } from "@ohbp/types";
export type { AutonomyMode, SharedBoardDisposition as BoardDisposition, ComparisonMode, DigestString, EvidenceChannelMode, PublicationState, SharedPublicationStateEvent as PublicationStateEvent, ReleasePolicy, RepeatabilityClass, SubmissionProfile, TrustTier, VisibilityClass, };
export type BudgetClass = "budget" | "standard" | "premium";
export type BoardId = "official-verified" | "reproducibility-frontier" | "community-lab";
...
export type InteractionTelemetry = Omit<SharedInteractionSummary, "protocol_version" | "classification_verdict"> & {
...
export interface VerificationRecord extends Omit<SharedVerificationRecord, "board_admission"> {
    board_admission: {
